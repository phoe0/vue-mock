<template>
  <div class="foot-btn">
    <ul>
      <router-link class="home" to="/home" tag="li" active-class="active">
        <a href="javascript:;"></a>
      </router-link>
      <router-link class="write" to="/none" tag="li" active-class="active">
        <a href="javascript:;"></a>
      </router-link>
      <router-link class="my" to="/user" tag="li" active-class="active">
        <a href="javascript:;"></a>
      </router-link>
    </ul>
  </div>
